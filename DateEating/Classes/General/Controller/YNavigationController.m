...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if (self.childViewControllers.count > 0) {// 如果push进来的不是第一个试图控制器
        ...
        [bankButton setImage:[UIImage imageNamed:@"navigationButtonReturn"] forState:(UIControlStateNormal)];
        [bankButton setImage:[UIImage imageNamed:@"navigationButtonReturnClick"] forState:(UIControlStateHighlighted)];
        ...
        bankButton.backgroundColor = [UIColor redColor];
        ...
        [bankButton setTitleColor:[UIColor redColor] forState:(UIControlStateHighlighted)];
