...
- (void)viewDidLoad {
    ...
    self.dateTableView.tag = 101;
    self.partyTableView.tag = 102;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.dateTableView) {
        ...
        cell.model = model;
        self.longPress = [UILongPressGestureRecognizer new];
        self.longPress.view.tag = tableView.tag;
        [cell.contentView addGestureRecognizer:self.longPress];
        [self.longPress addTarget:self action:@selector(deleteCell:)];
    }else{
